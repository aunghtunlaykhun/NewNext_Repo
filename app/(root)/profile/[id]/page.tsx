...
import { EMPTY_ANSWERS, EMPTY_QUESTON, EMPTY_TAGS } from "@/constants/state";
...
const Profile = async ({ params, searchParams }: RouteParams) => {
  ...
  console.log(logInUser?.user?.id, "loginuser id");
              ...
              render={(questions) => (
                <div className="flex w-full flex-col gap-6">
                  {questions.map((question) => (
                    <QuestionCard
                      showActionBtns={
                        logInUser?.user?.id === question.author._id
                      }
                      key={question._id}
                      question={question}
                    />
                ...
                <div className="flex w-full flex-col gap-10">
                  {answers.map((answer) => (
                    <AnswerCard
                      ...
                      showReadMore
                      showActionBtns={logInUser?.user?.id === answer.author._id}
