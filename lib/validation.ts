...
export const AskQuestionSchema = z.object({
    ...
    tags:z.array(z.string().min(1,{message:'Tag is required'}).max(30,{message:'Tag cannot exceed 30 characters'})).min(1,{message:'At least one tag is required'}).max(3,{message:'cannot add more than 3 tags'})
})