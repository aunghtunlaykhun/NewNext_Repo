...
const GlobalResult = () => {
  ...
  return (
    <div className="absolute top-full z-10 mt-3 w-full  bg-lihgt-800 py-5 shadow-sm dark:bg-dark-400 rounded-xl">
      <GlobalFilter />
      ...
      <div className="space-y-5">
        ...
        {isLoading ? (
          <div className="flex-center flex-col px-5">
            <LoaderIcon className="my-2 h-10 w-10 animate-spin text-primary-500" />
